...
extern void _cgoexp_45b1e13b81bf_nextValidIDCallback(void *, int, __SIZE_TYPE__);
...
void nextValidIDCallback(long int p0, OrderId p1)
{
	...
	a.p1 = p1;
	_cgo_tsan_release();
	crosscall2(_cgoexp_45b1e13b81bf_nextValidIDCallback, &a, 16, _cgo_ctxt);
	_cgo_tsan_acquire();
	_cgo_release_context(_cgo_ctxt);
}

CGO_NO_SANITIZE_THREAD
void _cgo_45b1e13b81bf_Cfunc__Cmalloc(void *v) {
	struct {
